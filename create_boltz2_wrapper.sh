#!/bin/bash
# Create compatibility wrapper for loading Boltz2 checkpoints with BoltzDesign1

cd /home/azureuser/localfiles/d3-boltz/BoltzDesign1

echo "=== Creating Boltz2 Compatibility Wrapper ==="
echo ""

# Create a wrapper module that filters incompatible parameters
...
"""
import torch
from boltz.model.models.boltz1 import Boltz1 as OriginalBoltz1
...
# Now update boltzdesign_utils.py to use the compatibility wrapper
echo ""
echo "Updating boltzdesign_utils.py to use compatibility wrapper..."

# Backup original
cp boltzdesign/boltzdesign_utils.py boltzdesign/boltzdesign_utils.py.backup.boltz2
